<%@ Page Title="" Language="C#" MasterPageFile="~/VideoPortal.Master" AutoEventWireup="true" CodeBehind="StudentLogin.aspx.cs" Inherits="OnlineVideoPortal.StudentLogin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style3" style="text-align: right">SAP ID: </td>
            <td style="text-align: left">
        ...
        <tr>
            <td colspan="2">New user? <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/StudentRegister.aspx">SignUp</asp:HyperLink>
            </td>
        </tr>
    </table>
    <br />
